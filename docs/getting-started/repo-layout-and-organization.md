...
- `lib/{YOUR_TEST_KIT_NAME}/requirements` - This folder contains a [template
  ...
  management infrastructure along with the corresponding csv files generated by the
  framework. The sample requirements are not referenced in the test suite.
